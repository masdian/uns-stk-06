...
1. ika diambil 30 rumah tangga sebagai contoh. Berapa persen rata-rata pengeluaran per bulan untuk konsumsinya antara 225 ribu rupiah dan 265 ribu rupiah?
]
...
## $$X \sim \underset{n \rightarrow \infty}{\text{sebarang sebaran}} \Rightarrow \bar{X} \sim \text{N}\left(\dfrac{\bar{X}-\mu}{\sigma/\sqrt{n}}\right)$$
